...
import "../interfaces/MakerDAO/ManagerLike.sol";
import "../interfaces/MakerDAO/DaiJoinLike.sol";
import "../interfaces/MakerDAO/GemJoinLike.sol";
import "../interfaces/MakerDAO/VatLike.sol";
import "../interfaces/MakerDAO/SpotLike.sol";
import "../interfaces/MakerDAO/JugLike.sol";
import "../interfaces/MakerDAO/DssAutoLine.sol";
...
library MakerDaiDelegateLib {
    ...
    function getPessimisticRatioOfCdpWithExternalPrice(
        ...
        uint256 totalCollateralValue = balanceOfCdp(cdpId, ilk).mul(price).div(
            WAD
        );
    ...
    function _forceMintWithinLimits(
        ...
        // uint256 line;  // Debt Ceiling              [rad]
        // uint256 dust;  // Urn Debt Floor            [rad]
        (uint256 Art, uint256 rate, , uint256 line, uint256 dust) = vat.ilks(
            ilk
        );
